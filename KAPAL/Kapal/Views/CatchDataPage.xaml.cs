...
{
    /// <summary>
    /// CatchDataPage menggunakan polymorphism melalui IRepository interface
    /// </summary>
    public partial class CatchDataPage : Page
    {
        private readonly AppState _state;
        private List<CatchWithVessel> _catchesWithVessel = new();
        ...
        private async Task LoadAsync()
        {
            try
            {
                ...
                _catchesWithVessel = catches.Select(c =>
                {
                ...
                dgCatches.ItemsSource = _catchesWithVessel;
            }
            catch (Exception ex)
            {
